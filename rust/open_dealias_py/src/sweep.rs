...
fn dealias_sweep_region_graph<'py>(
    ...
    metadata.set_item("seedable_region_count", result.seedable_region_count)?;
    metadata.set_item("unresolved_regions", result.unresolved_regions)?;
    ...
    metadata.set_item(
        ...
        result.safety_fallback_reason.clone(),
    )?;
